...
const List<String> MUSIC_DOWNLOAD_STORAGE_PATH = [
  STORAGE_NAME,
  MUSIC_STORAGE_NAME,
  MUSIC_DOWNLOAD_STORAGE_NAME,
];
const List<String> MUSIC_DOWNLOAD_PERMANENT_STORAGE_PATH = [
  STORAGE_NAME,
  MUSIC_STORAGE_NAME,
  MUSIC_DOWNLOAD_STORAGE_NAME,
  MUSIC_DOWNLOAD_IDENTIFIED_NAME,
];
const List<String> MUSIC_DOWNLOAD_TEMPORARY_STORAGE_PATH = [
  STORAGE_NAME,
  MUSIC_STORAGE_NAME,
  MUSIC_DOWNLOAD_STORAGE_NAME,
  MUSIC_DOWNLOAD_TEMPORARY_NAME,
];
const List<String> MUSIC_DOWNLOAD_APPLIER_PATH = [
  STORAGE_NAME,
  MUSIC_STORAGE_NAME,
  MUSIC_DOWNLOAD_STORAGE_NAME,
  MUSIC_DOWNLOAD_APPLIER_NAME,
];
const List<String> MUSIC_DOWNLOAD_CACHES_PATH = [
  STORAGE_NAME,
  MUSIC_STORAGE_NAME,
  MUSIC_DOWNLOAD_CACHES_NAME,
];
